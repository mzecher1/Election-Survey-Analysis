...
VCF0102.f <- factor(VCF0102)
is.factor(VCF0102.f)

VCF0104.f <- factor(VCF0104)
is.factor(VCF0104.f)

VCF0104.f <- factor(VCF0104)
is.factor(VCF0104.f)

VCF0880.f <- factor(VCF0880)
is.factor(VCF0880.f)

Dummy_dep <- ifelse (VCF0702 > 1, 1, 0)
summary (Dummy_dep)

Dummy_dep

Dummy_right_dir <- ifelse (VCF9222 > 1, 0, 1)
summary (Dummy_right_dir)

reg3 <- lm(Dummy_dep ~ VCF0102.f + VCF0104.f + Dummy_right_dir + VCF0880.f + VCF9229 + VCF0606 + VCF0501 + VCF9030a + VCF9206 + VCF0105b, weights= VCF0009z, data=Condensed_weights)
summary(reg3)
