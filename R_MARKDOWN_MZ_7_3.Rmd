...
reg_wsr <- lm(Voted_Y_N_DV ~ Age_Dummy  + Gender_DV + Race_DV + + Income_DV+ Education_DV + bw_parties_DV + Party_aff_DV  + Country_direction_DV + Control_split_DV + Election_Close_DV + Anyone_talk_vote_DV + Contacted_Dem_Party_DV + Contacted_by_party_DV + Contacted_Rep_Party_DV + Better_worse_DV + Volunteer_work_DV   + Dem_Pres_Angry_DV  + Dem_Pres_hopeful_DV + Rep_Pres_Angry_DV + Rep_Pres_hopeful_DV + Dem_Pres_Proud_DV + Dem_Pres_Afraid_DV + Rep_Pres_Afraid_DV + Rep_Pres_Proud_DV  + Interest_elec_DV  + RANKING +PercentDiff, weights= Weights,data=Data_State_rank)
...
Tables <-  %>% 
    table(
    (Data_State_rank$Voted_Y_N, Data_State_rank$Bw_parties),
    (Data_State_rank$Bw_parties,Data_State_rank$Dem_Pres_Afraid)
)
