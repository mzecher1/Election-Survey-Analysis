...
```{r}
#  Building cross tabs to examine the data 

And it allows you to provide more than just two columns. If you do three it will give you a list of tables - one for each category of the third variable.

TABLE_T_1 <- Data_Final_REG %>% janitor::tabyl(Voted_Y_N, Bw_parties)


TABLE_T_2 <-tabyl(Data_Final_REG$Voted_Y_N, Data_Final_REG$Bw_parties)

```{r}
Data_Final_REG %>% janitor::tabyl(Voted_Y_N, Bw_parties, Dem_Pres_Afraid)
```



# Logit Regression for the main analysis  
```{r}
...
# Tibble method to make ODDS RATIO CHARTS 
