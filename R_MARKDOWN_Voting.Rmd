...
ggsave(
  "OR_MIXED_Plot-Presentation Only",
  plot = last_plot(),
  device = "pdf",
  path = "visualizations",
  scale = 1,
...
pdf("visualizations/diffparties.pdf") 
...
pdf("visualizations/Elections_Close_GRAPH.pdf") 
